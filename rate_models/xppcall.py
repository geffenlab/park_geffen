...
def xpprun(filepath, version=8, xppname='xppaut', postfix='_tmp', parameters=None, inits=None, clean_after=False):
    ...
    if version < 8:
        ...
        try:
            ...
            print('terminal input: ',"%s %s -silent -with '%s' -runnow -outfile %s" % (xppname, fullfilename, inputstr,outputfilepath))
            ...
            print 'xpp was not called properly. check: xpp installation, xpp version, xpp alias.'
            ret = None
